...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <asp:Repeater ID="rptDetailTinTuc" runat="server">
        <ItemTemplate>
            <p style="margin-left: 15px; margin-top: 6px; font-family: 'Times New Roman'; font-weight: bold; color: #09489f; margin-bottom: 10px; font-size: 24px">
                <%#Eval("TIEUDE") %>
            </p>
            <span style="font-size: 13px; margin-left: 15px; color: #414955">Mã số:</span>
            <span style="font-size: 13px; font-family:'Segoe UI'; color: #000000"><%#Eval("TIEUDE") %></span> | 
            ...
            <p style="margin: 0 0 15px 15px; font-family:Tahoma; color: #414955; float:right; font-weight: bold; line-height:1.5; font-size: 15px;">
            ...
            <br />
            <p style="text-align: right; margin-right: 20px; font-size: 16px; font-family: 'Times New Roman'; font-weight: bold; color: #000000">
